...
rows_test1 = [
    ("SPY", 1, 10.0, 10.5, 9.5, 10.0, 1000),
    ("SPY", 2, 10.2, 10.7, 9.7, 10.2, 1000),
    ("SPY", 3, 9999.0, 9999.5, 9998.5, 9999.0, 1000),
    ("SPY", 4, 10.4, 10.9, 9.9, 10.4, 1000),
    ("SPY", 5, 10.6, 11.1, 10.1, 10.6, 1000),
]

rows_test2 = [
    ("SOLO", 1, 10.0, 10.5, 9.5, 10.0, 1000),
    ("ZVOL", 1, 10.0, 10.5, 9.5, 10.0, 0),
    ("ZCLS", 1, 10.0, 10.5, 9.5, 0.0, 1000),
    ("BADL", 1, 10.0, 10.5, 9.9, 9.5, 1000),
    ("NCLS", 1, 10.0, 10.5, 9.5, None, 1000),
]

rows_test3 = [
    ("AAA", 1, 10.0, 10.5, 9.5, 10.0, 1000),
    ("AAA", 2, 40.0, 40.5, 39.5, 40.0, 1000),
    ("BBB", 1, 50000.0, 50000.5, 49999.5, 50000.0, 1000),
    ("BBB", 2, 50100.0, 50100.5, 50099.5, 50100.0, 1000),
]
